...
public class Principal {
    public static void main (String[] args) {
        ...
        CambioDeDivisa monedas = new CambioDeDivisa();
        CambioDeTemperatura temperatura = new CambioDeTemperatura();
        ...
        String opciones = (JOptionPane.showInputDialog(null, "Seleccione una opción de conversión ", "Menu", JOptionPane.QUESTION_MESSAGE, null, new Object[] {"Conversor de Moneda", "Conversor de Temperatura"}, "Seleccion")).toString();
        	...
        	case "Conversor de Moneda":
                 ...
                 if(ValidarNumero(input) == true) {
                     double valorDeCambio = Double.parseDouble(input);
                     monedas.ConvertirMonedas(valorDeCambio);
             ...
             if(ValidarNumero(input) == true) {
                 double valorTemperatura = Double.parseDouble(input);
                 temperatura.ConvertirTemperatura(valorTemperatura);
